    ...
    <.tile docs="google-analytics-import">
        ...
        <div class="flex flex-col items-center justify-center pt-5 pb-6 max-w-md mx-auto">
          ...
          <div class="flex gap-x-4 mt-4">
            ...
            >
              Import from
              <img
                src={PlausibleWeb.URL.path("images/icon/google_analytics_logo.svg")}
            ...
            <.button_link
              disabled={@import_in_progress? or @at_maximum?}
              href={
                Routes.site_path(@socket, :csv_import, PlausibleWeb.SitePath.encode(@site.domain))
              }
              mt?={false}
            >
              Import from CSV
      ...
      <% else %>
        <div class="flex gap-x-4">
          ...
          <.button_link
            disabled={@import_in_progress? or @at_maximum?}
            href={Routes.site_path(@socket, :csv_import, PlausibleWeb.SitePath.encode(@site.domain))}
            mt?={false}
          >
            Import from CSV
          </.button_link>
